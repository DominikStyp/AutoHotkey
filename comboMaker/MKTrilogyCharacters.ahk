...
; In following variable we define characters list that will be displayed in GUI list
...
; Following classes MUST have same names as those in charList variable,
; but without spaces, and hyphens   
        ...
        ; Special character that you can choose to invoke kombat codes before a fight
		class KOMBAT_CODES extends MKTrilogyCharacter {
				;;;;;;;;;;; THE STAGES ;;;;;;;;;;;;
				; 079-035 STREETS
				_code1 := "HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 077-022 BRIDGE
				_code2 := "HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 004-700 SHAO KHAN'S CAVE
				_code3 := "LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP" 
				; 933-933 ERMAC'S PORTAL
				_code4 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK" 
				; 050-050 NOOB SAIBOT'S DORFEN
				_code5 := "HK,HK,HK,HK,HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK" 
				; 880-088 SUBWAY
				_code6 := "HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 666-444 SCORPION'S LAIR
				_code7 := "HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 820-028 PIT 3
				_code8 := "HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 343-343 ROOF TOP
				_code9 := "HP,HP,HP,HK,HK,HK,HK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK" 
				; 123-901 SOUL CHAMBER
				_code10 := "HP,HK,HK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-LK" 
				; 600-040 TEMPLE
				_code11 := "HP,HP,HP,HP,HP,HP,P2-HK,P2-HK,P2-HK,P2-HK" 
				; 002-003 THE WATERFRONT
				_code12 := "LK,LK,P2-LK,P2-LK,P2-LK" 
				; 666-333 THE GRAVE YARD
				_code13 := "HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK" 
				; 330-033 JADE'S DESERT
				_code14 := "HP,HP,HP,HK,HK,HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK" 
				;  BELL TOWER
				_code15 := "" 
				; 880-220 SHAO KHAN'S TOWER
				_code16 := "HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,P2-HP,P2-HP,P2-HK,P2-HK" 
				; 222-222 DEAD POLL
				_code17 := "HP,HP,HK,HK,LK,LK,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 191-191 ARMORY
				_code18 := "HP,HK,HK,HK,HK,HK,HK,HK,HK,HK,LK,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK" 
				; 919-919 THE PIT
				_code19 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,LK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 606-606 STAR BRIGDE
				_code20 := "HP,HP,HP,HP,HP,HP,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 101-101 THE TOWER
				_code21 := "HP,LK,P2-HP,P2-LK" 
				; 007-007 THE PORTAL
				_code22 := "LK,LK,LK,LK,LK,LK,LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 166-661 PIT 2
				_code23 := "HP,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK" 
				; 121-121 COURT YARD
				_code24 := "HP,HK,HK,LK,P2-HP,P2-HK,P2-HK,P2-LK" 
				; 212-212 WASTELAND
				_code25 := "HP,HP,HK,LK,LK,P2-HP,P2-HP,P2-HK,P2-LK,P2-LK" 
				; 000-666 THE LAIR
				_code26 := "P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				;;;;;;;;;;; HANDICAPS ;;;;;;;;;;;;
				; 033-000 P1 1/2 ENERGY
				_code27 := "HK,HK,HK,LK,LK,LK" 
				; 000-033 P2 1/2 ENERGY
				_code28 := "P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK" 
				; 707-000 P1 1/4 ENERGY
				_code29 := "HP,HP,HP,HP,HP,HP,HP,LK,LK,LK,LK,LK,LK,LK" 
				; 000-707 P2 1/4 ENERGY
				_code30 := "P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 024-689 SUPER ENDURANCE
				_code31 := "HK,HK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 390-000 P1 DOES 1/2 DAMAGE
				_code32 := "HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,HK" 
				; 000-390 P2 DOES 1/2 DAMAGE
				_code33 := "P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK" 
				; 555-556 NO SPECIAL MOVES
				_code34 := "HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 722-722 COMBOS DISABLED
				_code35 := "HP,HP,HP,HP,HP,HP,HP,HK,HK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 044-440 UNIKORN REF SANS POWER
				_code36 := "HK,HK,HK,HK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK" 
				; 100-100 THROWING DISABLED
				_code37 := "HP,P2-HP" 
				; 020-020 BLOCKING DISABLED
				_code38 := "HK,HK,P2-HK,P2-HK" 
				;;;;;;;;;;; DIFFERENT KOMBATS ;;;;;;;;;;;;
				; 040-404 REAL KOMBAT
				_code39 := "HK,HK,HK,HK,P2-HP,P2-HP,P2-HP,P2-HP,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 985-125 PSYCHO KOMBAT
				_code40 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 444-444 OR 460-460 RANDPER KOMBAT
				_code41 := "HP,HP,HP,HP,HK,HK,HK,HK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 688-422 DARK KOMBAT
				_code42 := "HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 300-300 SILENT KOMBAT
				_code43 := "HP,HP,HP,P2-HP,P2-HP,P2-HP" 
				; 109-901 BLOODY KOMBAT
				_code44 := "HP,LK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-LK" 
				;;;;;;;;;;; The winner of the first round fights... ;;;;;;;;;;;;
				; 205-205 CLASSIC SMOKE
				_code45 := "HP,HP,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 769-342 NOOB SAIBOT
				_code46 := "HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 969-141 MOTARO
				_code47 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK" 
				; 033-564 SHAO KHAN
				_code48 := "HK,HK,HK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 123-321 KHAMELEON
				_code49 := "HP,HK,HK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK" 
				;;;;;;;;;;; Secret Messages ;;;;;;;;;;;;
				; 717-313 RAIN CAN BE FOUND IN THE GRAVE YARD
				_code50 := "HP,HP,HP,HP,HP,HP,HP,HK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HK,P2-LK,P2-LK,P2-LK" 
				; 123-926 THERE IS NO KNOWLEDGE THAT IS NOT POWER!
				_code51 := "HP,HK,HK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 987-666 HOLD FLIPPERS DURING CASINO RUN
				_code52 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 282-282 NO FEAR,MAX COUNTDOWN,E B BUTTON,SKYDIVE
				_code53 := "HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 004-400 WHACHA GUN DO? E.B.
				_code54 := "LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP" 
				; 122-221 SKUNKY!!
				_code55 := "HP,HK,HK,LK,LK,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK" 
				; 448-844 DON'T JUMP AT ME
				_code56 := "HP,HP,HP,HP,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 550-550 PLAY THE WAVENET ULTIMATE MK 3
				_code57 := "HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK" 
				; 202-808 BABALITIES ARE REVERSIBLE!
				_code58 := "HP,HP,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				;;;;;;;;;;; Other Effects ;;;;;;;;;;;;
				; 484-484 AUTOMATIC KOMBOS
				_code59 := "HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 987-123 INVISIBLE ENERGY BARS
				_code60 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK" 
				; 999-999 SHOW THE REVISION #
				_code61 := "HP,HP,HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 466-466 UNLIMITED RUN
				_code62 := "HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 321-789 HYPER RUN JUMPS
				_code63 := "HP,HP,HP,HK,HK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 642-468 PLAY GALAGA
				_code64 := "HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				; 01-010 THROWING ENCOURAGED
				_code65 := "HK,P2-HP" 
				; 788-322 UPPERCUT RECOVERY
				_code66 := "HP,HP,HP,HP,HP,HP,HP,HK,HK,HK,HK,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK" 
				; 246-246 PLAY PONG
				_code67 := "HP,HP,HK,HK,HK,HK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HK,P2-HK,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
				;;;;;;;;;;; The following codes only work in "2 ON 2" and "3 ON 3" games ;;;;;;;;;;;;
				; 022-220 EXPLOSIVE KOMBAT and BLOCKING DISABLED
				_code68 := "HK,HK,LK,LK,P2-HP,P2-HP,P2-HK,P2-HK" 
				; 227-227 EXPLOSIVE KOMBAT
				_code69 := "HP,HP,HK,HK,LK,LK,LK,LK,LK,LK,LK,P2-HP,P2-HP,P2-HK,P2-HK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK,P2-LK" 
